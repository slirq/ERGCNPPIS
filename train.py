...
def main():
    ...
    ids_to_remove = ['3fqdA', '2j3rA', '3zr4B', '3h4sA', '3begA', '1mg9A', '1mg9B', '3cbjA']
    # Filter the DataFrame to exclude rows with 'ID' in the list
    train_dataframe = train_dataframe[~train_dataframe['ID'].isin(ids_to_remove)]
